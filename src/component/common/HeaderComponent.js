...
<div id="top-header">
  <div className="container">
    <ul className="header-links pull-left">
      <li><a href="#"><i className="fa fa-phone"></i> +9844673304</a></li>
      <li><a href="#"><i className="fa fa-envelope-o"></i> mahamayasoftwaresolutions@gmail.com</a></li>
      <li><a href="#"><i className="fa fa-map-marker"></i> Bangalore</a></li>
    </ul>
